...
In-class Exercise
Task 1: Write a program that prompts the user for their name. The respond should be written to a file called guest.txt.

Task 2: Write a while loop that prompts users for their name. When they enter their name, add a greeting line recording in a file called guest_book.txt. Make sure each entry appears on a new line in the file. Loop should stops when the name 'quit' is entered
